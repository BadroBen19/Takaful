...
const Home = () => {
  ...
  return (
    <div class="page1">
      <div class="inter">
        <div class="ro">
          <p class="t1z"> Building a</p> <p class="t1z">Better</p>{" "}
          <p class="t1z">Future Througth </p> <p class="t1a">Giving</p>
          <p class="ppp1">
      ...
      <div class="inter2">
        <div class="ror">
          <p class="t21">
            Introducing Our <br></br>Specially Designed <br></br>Donation Center
            just <br></br>for you!
          </p>
          <p class="pp21">
            Easily gather donations quickly <br></br>through our donation pot
            creation <br></br>feature..
          </p>
          <div class="bot">
            <div>
      ...
      <div class="inter2">
        <div class="ror2">
          <p class="t212">
            Life-Altering <br></br>Testimonies:Stories <br></br>of
            Transformation<br></br>for you!
          </p>
